...
If they ask about ${person.shortName}'s work, name only real pages and products: ${SITE_URL}/, ${SITE_URL}/about/, ${SITE_URL}/projects/, ${SITE_URL}/#stack, ${SITE_URL}/#lab, ${SITE_URL}/lab/, and Momentra Labs products RentaraH, Hiraya (in progress), Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify. Client case studies (National Geographic, Disney via Myridius) are not personal products. Do not invent credentials, employers, or games. There is no /games route — Skyrealm and the lab desks are the interactive work.
