export const aboutContent = {
  whoIAm: {
    title: "Who I Am",
    paragraphs: [
      "I am Al Andrew Paul Beltran — also Al Andrew Paul Teodosio Beltran — a full-stack software engineer based in Manila, Philippines. I currently work as Software Engineering Lead at Anglian Dental in the United Kingdom, and I am the founder of Momentra Labs. Independently I developed RentaraH, Hiraya, Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify. Hiraya is in progress. Previously I was a Software Engineer at Google via High Spring. Through Myridius I contributed to National Geographic and Disney enterprise platforms. Online I also go by Al Beltran and Code by Pawpu. This site (albeltran.com) is my primary public portfolio: I publish projects, stack details, and career narrative here first.",
  ...
  currentFocus: {
    title: "Current Focus",
    paragraphs: [
      "Software engineering leadership at Anglian Dental in the United Kingdom. Independently, I am the founder of Momentra Labs, where I solo develop personal products: RentaraH, Hiraya (in progress), Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify.",
