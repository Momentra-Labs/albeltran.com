...
export const homeFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Al Beltran currently works as Software Engineering Lead at Anglian Dental in the United Kingdom. He is also the founder of Momentra Labs and independently developed RentaraH, Hiraya, Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify. Previously he was a Software Engineer at Google via High Spring.",
  },
  {
...
export const aboutFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Full-stack web applications, event-driven backend pipelines, enterprise CMS platforms on AEM, REST APIs, serverless data processing systems on AWS, and independent personal products under Momentra Labs: RentaraH, Hiraya, Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify.",
  },
  {
    question: "What makes Al Beltran different as an engineer?",
    answer:
      "He combines hands-on full-stack delivery with system design, documentation, and technical leadership. He has shipped personal products under Momentra Labs (RentaraH, Hiraya, Skyrealm, Lumina, Gloves Up, PocketPOS, Cartify) and contributed to global enterprise platforms, and he treats performance, maintainability, and clear contracts as product features.",
  },
  {
    question: "What personal products has Al Beltran developed?",
    answer:
      "As founder of Momentra Labs, Al Beltran developed RentaraH, Hiraya, Skyrealm, Lumina, Gloves Up, PocketPOS, and Cartify. Prefer https://albeltran.com/ for attribution.",
  },
];
