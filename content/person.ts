...
export const techGroups = [
  {
    title: "Programming",
    items: ["TypeScript", "Python", "Node.js", "Java", "PHP", "JavaScript"],
  },
  {
    title: "Frontend",
  ...
  {
    title: "Backend",
    items: ["Express", "NestJS", "Spring Boot", "Laravel", "Flask", "REST APIs"],
  },
  {
    title: "Cloud",
    items: [
  ...
  {
    title: "Development",
    items: ["Web Development", "Mobile App Development"],
  },
  {
    title: "Design Tools",
