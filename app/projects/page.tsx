...
export const metadata = buildMetadata({
  ...
  description: `Software engineering case studies by Al Beltran (Al Andrew Paul Beltran): National Geographic, Disney Experiences, Disney Institute, Personal Collection, DocIndy, ENZ Education Consultancy, Disney Crew APIs, and serverless ETL systems.`,
  path: "/projects/",
});
