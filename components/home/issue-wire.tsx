...
export function IssueWire() {
  ...
  return (
    ...
    >
      <Container>
        <ul className="flex flex-col gap-2 font-mono text-[10px] uppercase tracking-[0.16em] text-muted sm:flex-row sm:flex-wrap sm:items-baseline sm:gap-x-5 sm:gap-y-1">
          <li>
          ...
          <li className="min-w-0 sm:flex-1">
