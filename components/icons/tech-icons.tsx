...
type AwsTileProps = Omit<IconProps, "from" | "to"> & {
  from: string;
  to: string;
};
...
function LambdaIcon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_ORANGE}>
      <path
        fill="#fff"
...
function S3Icon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_GREEN}>
      <path
        fill="#fff"
...
function SqsIcon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_PINK}>
      <path
        fill="#fff"
...
function ApiGatewayIcon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_PINK}>
      <path
        fill="#fff"
...
function Ec2Icon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_ORANGE}>
      <path
        fill="#fff"
...
function StepFunctionsIcon({ className }: IconProps) {
  return (
    <AwsTile className={className} {...AWS_PINK}>
      <path
        fill="#fff"
